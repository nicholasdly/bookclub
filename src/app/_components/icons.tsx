...
export function BookclubLogoIcon({ className }: IconProps) {
  return (
    <svg
...
export function MessageOffIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function MoodSmileBeamIcon({ className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={className}
...
export function HamburgerMenuIcon({ className }: IconProps) {
  return (
